...
export const pt: Dict = {
  ...
  meta: {
    home: {
      ...
      description:
        "A Serenitech é uma empresa de robótica cognitiva com IA para a gestão embaixo d'água de portos, plataformas offshore, estruturas submarinas e indústria naval. Sensoriamento, monitoramento, medições e serviços em nuvem além da linha d'água.",
    },
    services: {
  ...
  home: {
    ...
    problem: {
      eyebrow: "O PROBLEMA",
      title:
        "Tudo o que você opera depende do que acontece embaixo d'água. Quase nada disso é medido continuamente.",
      items: [
        {
        ...
        },
        {
          ...
          text: "Colisões de atracação, vibração e deriva estrutural em píeres, dolfins e pernas de jaquetas passam sem medição até o reparo — ou a disputa.",
        },
        {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Unidades robóticas cognitivas autônomas em píeres, dolfins, muros de cais, pernas de jaquetas e ativos submarinos: deslocamento, espectro de vibração, choques e impactos registrados.",
        },
        {
    ...
    leadership: {
      eyebrow: "LIDERANÇA",
      title: "Fundada por um empreendedor e um cientista.",
      link: "Empresa",
      people: [
        {
          name: "Rodrigo Füchter",
          role: "CEO e cofundador",
          line: "Estratégia, estrutura societária, finanças e a expansão do grupo.",
        },
        {
          name: "Dr. Thierry Deschamps de Paillette",
          role: "CTO e cofundador",
          line: "Tecnologia, laboratórios e arquitetura de produto.",
        },
      ],
    },
    finalCta: {
  ...
  services: {
    ...
    modules: [
      ...
      },
      {
        ...
        matters:
          "Evidência para responsabilidade e seguros, menos reparos não planejados, gestão de integridade de estruturas que nenhum mergulhador inspeciona todo dia.",
        bullets: [],
      },
      {
    ...
    items: [
      {
        ...
        text: "Canal de acesso, bacias e berços sob vigilância subaquática contínua: calado dinâmico e UKC, assoreamento preditivo, conformidade de ruído, verificação de embarcações e registro de impactos. Integra-se ao VTMIS e ao ERP do porto.",
        outcome:
      ...
      },
      {
        ...
        text: "Pernas de jaquetas, risers, sistemas de amarração e equipamentos submarinos monitorados quanto a movimento, vibração, impacto e erosão do leito; detecção de aproximação de embarcações não identificadas; monitoramento de ruído subaquático em perfuração e construção.",
        outcome:
  ...
  technology: {
    ...
    research: {
      ...
      text: "Eletrônica de alta frequência, fotônica, telecomunicações subaquáticas, processamento de sinais e IA — cultura de laboratório em Mônaco e Florianópolis dedicada ao ambiente subaquático.",
    },
  },
  company: {
    eyebrow: "EMPRESA",
